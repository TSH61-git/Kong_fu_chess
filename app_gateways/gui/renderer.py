...
class Renderer:
    ...
    def draw(
        ...
        self._draw_side_panel(canvas, captured, scores, history, board_px_w, board_px_h)
    ...
    def _draw_side_panel(
        ...
        self._draw_captured_section(canvas, captured, scores, px, captured_h)
    ...
    def _draw_captured_section(
        self, canvas: Img, captured: dict, scores: dict, px: int, section_h: int
    ) -> None:
        canvas.put_text(f"White captured: ({scores[Color.WHITE]})", px + 8, 22, 0.5, (255, 255, 255, 255), 1)
        ...
        canvas.put_text(f"Black captured: ({scores[Color.BLACK]})", px + 8, mid + 22, 0.5, (200, 200, 200, 255), 1)
